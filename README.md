...
\
By default, it should be noticeably faster than std::unordered_map, altough further optimiation is necesary.
...
The size of the bucket is always of 2^n in order to optimally trim the hash.
